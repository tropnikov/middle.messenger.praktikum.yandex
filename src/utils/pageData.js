export const pageData = {
  ...
  "/pages/edit-profile.html": {
    ...
    inputs: [
      ...
      { name: "display_name", label: "Имя в чате", type: "text", required: true, value: "Иван" },
      { name: "phone", label: "Телефон", type: "text", required: true, value: "+7 (909) 967 30 30" },
    ],
  ...
  "/pages/change-password.html": {
    title: "Максим",
    inputs: [
      { name: "oldPassword", label: "Старый пароль", type: "password", required: true, value: "⋅⋅⋅⋅⋅⋅" },
      { name: "newPassword", label: "Новый пароль", type: "password", required: true, value: "⋅⋅⋅⋅⋅⋅" },
      {
